...
function affAide()
	...
	$Texte = "
		<div id=\"body\" class=\"texte\">
			...
			<p>L'<span class=\"clef\">interface</span> se décompose en deux parties indépendantes : la partie supérieure contient un onglet par action que vous pouvez effectuer, la partie inférieure un onglet par affichage que RICA peut générer. Chaque onglet supérieur contient un petit <span class=\"clef\">résumé des fondamentaux</span> pour l'action considérée. <span class=\"clef\">Le bouton à l'effigie de votre clan</span> avec votre pseudo vous permet de vous déconnecter (et de supprimer votre connexion automatique si vous l'aviez demandée). Les <span class=\"clef\">résultats de recherche</span> se présentent sous forme de liste, chaque ligne correspond à une entrée (un rapport de combat, une carte ...), cliquez sur son titre pour voir les informations extraites, cliquez sur le trombone doré pour accéder à l'entrée complête. Notez qu'une recherche par mot clé affiche directement les informations extraites pertinentes par défaut.</p>
			...
			<p>Pour chaque rapport que vous entrez, de nombreuses informations en sont extraites ou récoltées par d'autres moyens puis condensées sous la forme d'un message qui sera affiché lors des recherches. Ces messages se composent d'un titre, qui permet d'afficher les informations détaillée lorsque vous <span class=\"clef\">cliquez</span> dessus et de voir le <span class=\"clef\">rapport complet</span> dont le lien est donné dans les informations détaillées. Ce titre donne le résultat du combat (Victoire, Défaite, Destruction, Capture, Meurtre), le type de cible (Flotte, Planète), le nom du joueur ciblé et la position de l'objet attaqué.</p>
